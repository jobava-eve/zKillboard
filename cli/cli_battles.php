		...
		foreach($battles as $battle)
		{
			if($battle["checked"] == 0)
			{
				...
				if(!empty($kills))
				{
					...
					Db::execute("INSERT INTO zz_battles (battleID, solarSystemID, solarSystemName, regionID, regionName, dttm, teamAkills, teamApilotCount, teamApoints, teamAinvolved, teamBkills, teamBpilotCount, teamBpoints, teamBinvolved)
						VALUES (:battleID, :solarSystemID, :solarSystemName, :regionID, :regionName, :dttm, :teamAkills, :teamApilotCount, :teamApoints, :teamAinvolved, :teamBkills, :teamBpilotCount, :teamBpoints, :teamBinvolved)",
						array(
							":battleID" => $battleID,
...
// update zz_battle_report (checked)
//zz_battles (battleID, solarSystemID, solarSystemName, timestamp, teamAkills, teamBkills, teamApilotCount, teamBpilotCount, teamApoints, teamBpoints, teamAinvolved, teamBinvolved)
				}
			}
		}
	}
