...
class api_docs implements apiEndpoint
{
	public function getDescription()
	{
		return array("type" => "description", "message" =>
				"Shows autogenerated documentation for the API"
			);
	}
	...
	public function execute($parameters)
	{
		...
		foreach($data as $e)
			if(!in_array($e, array(".", "..", "help.php", "docs.php", "list.php", "parameters.php", "base.txt")))
				$endPoints[str_replace(".php", "", $e)] = self::information(str_replace(".php", "", $e));

		return $endPoints;
	}

	private static function information($endpoint)
	{
		try
		{
			...
			$data = array("description" => $class->getDescription()["message"], "parameters" => $class->getAcceptedParameters()["parameters"]);
		}
		catch (Exception $e)
		{
			$data = array(
