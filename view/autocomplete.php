...
$entities = array(
		array('type' => 'ship',        'query' => 'select i.typeID as id, i.typeName as name from ccp_zship_search c left join ccp_invTypes i on (c.typeID = i.typeID) where i.typeName like :query', 'image' => 'Type/%1$d_32.png'),
